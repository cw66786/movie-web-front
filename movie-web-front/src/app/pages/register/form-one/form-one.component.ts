...
export class FormOneComponent implements OnInit {
  ...
  constructor(public errorMatcher: FormErrorService, private fb: FormBuilder,private formService: FormServicesService) {}

  ngOnInit(): void {
    this.registerForm1 = this.fb.group({
      email: new FormControl('', [Validators.email, Validators.required ],[this.emailChecker]),
